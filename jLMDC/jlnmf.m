function  [Bt,Ot,Ct,errorr]=jlnmf(d,l,lambda,gamma,iter,M1,M2,M3)
% 2019.12.16
...
% UPdate Bt
    parfor i=1:n
        ...
        Bt(i,:)=BT(i,:).*((2*M1(i,:)*OT')./(2*BT(i,:)*(OT*OT')+gamma*V(i,:)))+eps;
    end
	Rowadd=sum(Bt,2);
